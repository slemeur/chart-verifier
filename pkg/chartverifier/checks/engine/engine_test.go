...
func VestSortTemplates(t *testing.T) {
...
func TestRender(t *testing.T) {
	c := &chart.Chart{
		...
		Templates: []*chart.File{
			...
			{Name: "templates/test5", Data: []byte("{{name: \"{{ include \"chart.fullname\" . }}-test-connection\"}}")},
		},
		Values: map[string]interface{}{"outer": "DEFAULT", "inner": "DEFAULT", "extra" : "more"},
	}
	...
	expect := map[string]string{
		...
		"moby/templates/test5": `{"global":{"callme":"Ishmael"},"inner":"inn","outer":"spouter"}`,
	}
...
func VestRenderRefsOrdering(t *testing.T) {
...
func VestRenderInternals(t *testing.T) {
...
func VestParallelRenderInternals(t *testing.T) {
...
func VestParseErrors(t *testing.T) {
...
func VestExecErrors(t *testing.T) {
	vals := chartutil.Values{"Values": map[string]interface{}{}}
...
func VestAllTemplates(t *testing.T) {
	ch1 := &chart.Chart{
...
func VestRenderDependency(t *testing.T) {
...
func VestRenderNestedValues(t *testing.T) {
...
func VestRenderBuiltinValues(t *testing.T) {
	inner := &chart.Chart{
...
func VestAlterFuncMap_include(t *testing.T) {
	c := &chart.Chart{
...
func VestAlterFuncMap_require(t *testing.T) {
	c := &chart.Chart{
...
func VestAlterFuncMap_tpl(t *testing.T) {
	c := &chart.Chart{
...
func VestAlterFuncMap_tplfunc(t *testing.T) {
	c := &chart.Chart{
		Metadata: &chart.Metadata{Name: "TplFunction"},
		Templates: []*chart.File{
...
func VestAlterFuncMap_tplinclude(t *testing.T) {
	c := &chart.Chart{
		Metadata: &chart.Metadata{Name: "TplFunction"},
		Templates: []*chart.File{
...
func VestRenderRecursionLimit(t *testing.T) {
